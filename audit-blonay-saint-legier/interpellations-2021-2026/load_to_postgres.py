...
SPEC = importlib.util.spec_from_file_location("blonay_saint_legier_loader", SOURCE)
...
def main() -> None:
    ...
    module.DOCUMENT_PREFIX = "blonay-saint-legier_interpellation_"
    module.CATEGORY = "interpellation"
    module.SPECIFIC_METADATA_KEY = "interpellation_metadata"
    module.RECIPE_VERSION = "blonay-saint-legier-interpellations-v1"
