...
SPEC = importlib.util.spec_from_file_location("blonay_saint_legier_motion_loader", SOURCE)
...
def main() -> None:
    ...
    module.DOCUMENT_PREFIX = "blonay-saint-legier_motion_"
    module.CATEGORY = "motion"
    module.SPECIFIC_METADATA_KEY = "motion_metadata"
    module.RECIPE_VERSION = "blonay-saint-legier-motions-v1"
