...
def main() -> None:
    ...
    with psycopg.connect(database_url, row_factory=dict_row) as connection:
        with connection.cursor() as cursor:
            cursor.execute(
                ...
                "FROM documents WHERE document_id LIKE 'blonay-saint-legier\\_motion\\_%%' ESCAPE '\\'"
            )
            ...
            cursor.execute(
                ...
                "FROM chunks WHERE document_id LIKE 'blonay-saint-legier\\_motion\\_%%' ESCAPE '\\'"
            )
            ...
            cursor.execute(
                ...
                "FROM documents d WHERE d.document_id LIKE 'blonay-saint-legier\\_motion\\_%%' ESCAPE '\\'"
    ...
    retrieval_specs = [
        ("réduction du nombre de conseillers municipaux de 7 à 5", "blonay-saint-legier_motion_2351878_"),
        ("densification raisonnée", "blonay-saint-legier_motion_2265628_"),
        ("révision du Plan Directeur communal", "blonay-saint-legier_motion_2233933_"),
    ]
    retrieval = []
    for query, prefix in retrieval_specs:
        rows = pilot_v2_store.search(
            query,
            limit=10,
            filters={"city": "Blonay–Saint-Légier", "doc_type": "motions"},
        )
