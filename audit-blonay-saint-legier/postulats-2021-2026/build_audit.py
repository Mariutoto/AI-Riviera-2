...
def main() -> None:
    ...
    for item in inventory["objects"]:
        ...
        document_id = f"blonay-saint-legier_postulate_{item['source_object_id']}_text"
    ...
    summary = {
        ...
        "objects_with_synthetic_text": sum(
            not item["has_postulate_text"] for item in objects.values()
        ),
    ...
    audit = {
        "schema_version": "blonay-saint-legier-postulates-general-audit-v1",
    ...
    (OUTPUT_DIR / "index.html").write_text(
        "<!doctype html><html lang='fr'><meta charset='utf-8'><body>"
        "<h1>Postulats de Blonay–Saint-Légier — législature 2021–2026</h1>"
