...
SPEC = importlib.util.spec_from_file_location("veytaux_motion_loader", SOURCE)
...
def main() -> None:
    ...
    module.DOCUMENT_PREFIX = "veytaux_motion_"
    module.CATEGORY = "motion"
    module.SPECIFIC_METADATA_KEY = "motion_metadata"
    module.RECIPE_VERSION = "veytaux-motions-v1"
