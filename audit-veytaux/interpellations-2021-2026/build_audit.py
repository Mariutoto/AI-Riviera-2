...
def metadata_record(spec: dict, objects: dict[str, dict]) -> dict:
    ...
    original_ids = [f"veytaux_interpellation_{item['object_id'].split('veytaux-interpellation-', 1)[-1]}_text" for item in linked]
...
def main() -> None:
    ...
    audit = {
        "schema_version": "veytaux-interpellations-general-audit-v1",
    ...
    (OUTPUT_DIR / "index.html").write_text(
        "<!doctype html><html lang='fr'><meta charset='utf-8'><body>"
        "<h1>Interpellations de Veytaux — législature 2021–2026</h1>"
