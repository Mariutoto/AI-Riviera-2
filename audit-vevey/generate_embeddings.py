...
EMBEDDING_DIR = ROOT / "combined-interpellations-audit" / "embedding"
...
def main() -> None:
    ...
    for record in inputs:
        ...
        if (
            ...
            and cached.get("embedding_input_hash") == expected_hash
        ):
    ...
    with OUTPUT_PATH.open("w", encoding="utf-8", newline="\n") as stream:
        for record in inputs:
            stream.write(
                json.dumps(results[record["chunk_id"]], ensure_ascii=False)
                + "\n"
            )
