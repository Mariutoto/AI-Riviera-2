...
def metadata_record(spec: dict, objects: dict[str, dict]) -> dict:
    ...
    original_ids = [
        f"montreux_motion_{item['source_object_id']}_text" for item in linked
    ]
...
def main() -> None:
    ...
    for item in inventory["objects"]:
        ...
        document_id = f"montreux_motion_{item['source_object_id']}_text"
        specs.append(
            {
    ...
    audit = {
        "schema_version": "montreux-motions-general-audit-v1",
    ...
    (OUTPUT_DIR / "index.html").write_text(
        "<!doctype html><html lang='fr'><meta charset='utf-8'><body>"
        "<h1>Motions de Montreux — législature 2021–2026</h1>"
